...
const HeaderProfile = ({ showUserMenus, setShowUserMenus, dropdownRef }) => {
	const openUserMenu = () => {
	...
	return (
		<>
			...
			<div
				...
				className={
					showUserMenus
						? " bg-white rounded-xl w-[300px] min-h-[100px] fixed top-0 right-0 z-[60]  mt-[100px] mr-[30px] p-[25px] shadow-sm flex flex-col justify-center"
						: "hidden"
				}
			>
				<Link href="/sign-in">
