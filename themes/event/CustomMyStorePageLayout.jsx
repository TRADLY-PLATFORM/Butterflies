...
import StoreListings from '../../components/MyStore/MyStoreListings/StoreListings';
import NoProducts from '../../components/MyStore/NoProducts/NoProducts';
import NoStore from '../../components/MyStore/NoStore/NoStore';
import StoreProfile from '../../components/MyStore/StoreProfile/StoreProfile';
import PaginationFunction from '../../components/Shared/Pagination/Pagination';
import ReactPaginate from 'react-paginate';
import CustomStoreProfile from '../../components/MyStore/StoreProfile/CustomStoreProfile';

const CustomMyStorePageLayout = () => {
    ...
    <div>
      {my_stores !== null &&
        (my_stores.length > 0 ? (
          <div>
            <div>
              <CustomStoreProfile my_stores={my_stores} />
            </div>
            <div className=" mt-6">
...
export default CustomMyStorePageLayout;
